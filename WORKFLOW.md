...
tracker:
  ...
  project_slug: synclax-84f72d69cb2b
  active_states:
    - Todo
    - In Progress
    - Merging
...
The agent should be able to talk to Linear via the configured Linear MCP server. If it is not present, stop and report it as a blocker.
